    ...
    <Layout>
      ...
      <Stack as="main">
        ...
        <Text>
          ...
          development, but have experience programming for backend. I also have
          a hobby of learning about SysAdmin and DevOps. I wouldn't call myself
          a full-stack developer, since I don't think I have enough experience
          to qualify as such just yet.
        </Text>
        <Text>
